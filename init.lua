...
vim.keymap.set({ 'n', 'v', 'i', 'c' }, '<left>', '<cmd>echo "Use h to move!!"<CR>')
vim.keymap.set({ 'n', 'v', 'i', 'c' }, '<right>', '<cmd>echo "Use l to move!!"<CR>')
vim.keymap.set({ 'n', 'v', 'i', 'c' }, '<up>', '<cmd>echo "Use k to move!!"<CR>')
vim.keymap.set({ 'n', 'v', 'i', 'c' }, '<down>', '<cmd>echo "Use j to move!!"<CR>')
